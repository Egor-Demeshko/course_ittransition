...
export const BIGGEST_COLLECTION = "Biggest collections";
...
export const ENTER_STRING = "Enter string text";
...
export const ENTER_CHECKBOX = "Enter true/false value";
...
export const NO_REQUEST_OBJ = "No request object provided!";
